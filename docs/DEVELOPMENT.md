...
The domain is verified headlessly: the **`node:test` unit suite** and **563 Gherkin scenarios
(4137 steps)** across source, program-out, mix/nam, matte, wipe, colour-correction, the five
