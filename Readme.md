...
framework (ADR-0003). Current status: **Phases 0–6 complete** — two buses + Matte
...
Audio API), and the **Fade stage + Auto Take/Auto Fade** (frame-counted, pausable
transitions on the canonical clock). Next: event memory + special modes (Phase 7). See
